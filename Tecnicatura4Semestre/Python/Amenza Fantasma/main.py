...
def main():
    ...
    while running:
        ...
        for enemigo in enemigos[:]:
            enemigo.mover()
            eliminar_enemigo = False  # bandera para eliminarlo al final

            # Si sale de la pantalla
            if enemigo.rect.top > SCREEN_HEIGHT:
                eliminar_enemigo = True
            ...
            # Eliminar el enemigo solo una vez, al final
            if eliminar_enemigo and enemigo in enemigos:
